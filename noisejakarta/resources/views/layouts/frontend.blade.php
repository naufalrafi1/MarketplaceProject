...
<html lang="en">
    <head>
        ...
        <meta content="Noise Jakarta Menjual berbagai macam aksesoris dan pakaian pria dan wanita" name="description">
        <meta content="{{ $title ?? 'App Toko' }}" name="keywords">
        <meta property="og:locale" content="ID_id"/>
        <meta property="og:type" content="website"/>
        <meta property="og:image" content="{{ asset('assets/img/logonoisejakarta.png') }}">
        <!-- Bootstrap CSS -->
        <link rel="shortcut icon" href="{{ asset('assets/img/logonoisejakarta.png') }}">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-md navbar-custom shadow-sm py-3 fixed-top">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}"><b>Noise Jakarta</b></a>
        ...
        <div class="copyright">
            <div class="container text-center text-white">
                Copyright &copy; <?= date('Y');?> Noise Jakarta
            </div>
        </div>
        <!-- end footer -->
        <!-- modal cari -->
